...
# compiler, standard, and md307 libraries. 
# depending on the build target, link against simulation or hardware libraries.
ifeq ($(BUILD_TARGET),1)
LDLIBS += -l:md307-runtime.a -ldbg307-cold -ltftmd307-cold -lgcc -lc_nano
else
LDLIBS += -l:md307-runtime.a -ldbg307-sim -ltftmd307-sim -lgcc -lc_nano
endif
